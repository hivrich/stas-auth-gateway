...
// Add new imports for STAS/ICU routes
let stasRoutes, icuRoutes;
try {
  stasRoutes = require('./routes/stas');
  icuRoutes = require('./routes/icu');
  console.log('✅ STAS/ICU routes loaded');
} catch (e) {
  console.log('⚠️ STAS/ICU routes not available:', e.message);
}
